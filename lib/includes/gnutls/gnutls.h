...
#define GNUTLS_VERSION_NUMBER 0x030407
 ...
 * @GNUTLS_CRT_KRB: Kerberos ticket
 *
 ...
 * @GNUTLS_SIGN_KDH_SHA256: Kerberos authenticator with SHA256.
 * @GNUTLS_SIGN_KDH_SHA384: Kerberos authenticator with SHA384.
 * @GNUTLS_SIGN_KDH_SHA512: Kerberos authenticator with SHA512.
 *
...
typedef enum {
	...
	// ARPA2 added by TomV for TLS-KDH:
	GNUTLS_SIGN_KDH_SHA256 = 19,
	GNUTLS_SIGN_KDH_SHA384 = 20,
	GNUTLS_SIGN_KDH_SHA512 = 21
	// end
} gnutls_sign_algorithm_t;
 ...
 * @GNUTLS_CTYPE_IGNORE: for usage with "old" symmetric mode.
 *
 * Enumeration of certificate type modes with respect to asymmetric
 * certificate types as specified in RFC7250.
 */
typedef enum {
	GNUTLS_CTYPE_CLIENT,
	GNUTLS_CTYPE_SERVER,
...
int gnutls_certificate_get_x509_key(gnutls_certificate_credentials_t res,
                                    unsigned index,
                                    gnutls_x509_privkey_t *key); //REMARK: why is this func defined twice?
int gnutls_certificate_get_x509_crt(gnutls_certificate_credentials_t res,
                                    unsigned index,
                                    gnutls_x509_crt_t **crt_list,
                                    unsigned *crt_list_size); //REMARK: why is this func defined twice?
...
// ARPA2 added by TomV for TLS-KDH:					  
/* KDH functions */
/* REMARK: maybe place these prototypes in a seperate directory / file in the future?
