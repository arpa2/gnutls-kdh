...
static const gnutls_pk_map pk_mappings[] = {
	...
	// ARPA2 added by TomV & RickvR for TLS-KDH, KDH-Only variant:
	{GNUTLS_KX_ECDHE_KDH, GNUTLS_PK_KDH, CIPHER_SIGN},
	{GNUTLS_KX_ECDHE_KDH_RSA, GNUTLS_PK_RSA, CIPHER_SIGN},
	{GNUTLS_KX_ECDHE_KDH_ECDSA, GNUTLS_PK_EC, CIPHER_SIGN},
	{GNUTLS_KX_ECDHE_KDH_DSA, GNUTLS_PK_DSA, CIPHER_SIGN},
	// end 
